...
DEVICE_PATH := device/huami/watch
...
# Assert
TARGET_OTA_ASSERT_DEVICE := watch
...
TARGET_KERNEL_HEADER_ARCH := mips
TARGET_KERNEL_SOURCE := kernel/huami/watch
TARGET_KERNEL_CONFIG := watch_defconfig
